...
<div class="container">
    <div class="col-md-12">
      ...
      <a href="/todo/showadd"><button class="btn btn-primary" type="button">Add Work</button></a>
            ...
            <form role="form" class="form-horizontal style-form"  action="/todo/work/daylist" method="POST">
                {{ csrf_field() }}
                <div>
                @if (count($errors)>0)
                ...
                <label class="col-lg-12 control-label">Choise a Day (*)</label>
                <div class="col-lg-10">
